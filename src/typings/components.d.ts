...
declare global {
  ...
  const IconMdiPhoneOutline: typeof import('~icons/mdi/phone-outline')['default']
  const IconMdiShieldKeyOutline: typeof import('~icons/mdi/shield-key-outline')['default']
